...
@Tag(name = "공지사항(Notice)", description = "공지사항(Notice) API입니다.")
public class NoticeController {
  ...
  @GetMapping("/list")
  public BaseResponse<NoticeResponse.PreviewPageDto> getNoticePreview(
      @AuthMember MemberInfoDto memberInfoDto,
      @RequestParam(defaultValue = "0") int page,
      @RequestParam(defaultValue = "12") int size
  ) {
    NoticeResponse.PreviewPageDto result = noticeService.getNoticePreview(memberInfoDto, page, size);
